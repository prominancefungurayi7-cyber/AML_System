...
Verify the integrity of the SMOTE + XGBoost experiment results.
...
print("=" * 80)
print("STAGE 19 INTEGRITY VERIFICATION")
print("=" * 80)
...
with open('ml_stage19_smote_xgboost_results.json', 'r') as f:
...
# Verify recall from confusion matrix
suspicious_idx = label_encoder.transform(['suspicious'])[0]
super_suspicious_idx = label_encoder.transform(['super_suspicious'])[0]
...
integrity_checks = {
    ...
    "random_state=42 used": bool(xgb_config.get('random_state') == 42),
...
integrity_results = {
    ...
    "verification_type": "Stage 19 Integrity Check",
...
with open('ml_stage19_smote_xgboost_integrity_check.json', 'w') as f:
    json.dump(integrity_results, f, indent=2)

print("=" * 80)
print("STAGE 19 INTEGRITY VERIFICATION COMPLETE")
print("=" * 80)
print("Integrity check results saved to ml_stage19_smote_xgboost_integrity_check.json")
