...
Test whether SMOTE can improve minority-class detection using the same 18 features
and same training/test methodology as the frozen champion.
"""
...
print("=" * 80)
print("STAGE 18: SMOTE EXPERIMENT")
print("=" * 80)
...
for config in smote_configs:
    ...
    cv_macro_f1_scores = cross_val_score(gb, X_train_resampled, y_train_resampled, cv=cv, scoring='f1_macro')
...
results = {
    ...
    "experiment_type": "Stage 18: SMOTE Experiment",
...
with open('ml_stage18_smote_experiment_results.json', 'w') as f:
    json.dump(results, f, indent=2)

print("=" * 80)
print("STAGE 18 SMOTE EXPERIMENT COMPLETE")
print("=" * 80)
print("Results saved to ml_stage18_smote_experiment_results.json")
